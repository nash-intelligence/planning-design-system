import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{d as t}from"./iframe-DRKoeqy-.js";import{a as n,f as r,i,t as a,u as o}from"./axis-DXE0zhdt.js";import{t as s}from"./jsx-runtime-DeHZSEgm.js";function c(e){let[t,a]=(0,l.useState)(null),s=(e,t)=>a({area:e,screen:t}),c=t??{area:`Home`,screen:`Overview`};return(0,u.jsx)(r,{navigation:{activeArea:c.area,activeScreen:c.screen,areas:n,audience:e.audience,onNavigate:s},children:t?(0,u.jsx)(o,{activeArea:t.area,activeScreen:t.screen,areas:n,audience:e.audience,onExit:()=>a(null),onNavigate:s}):(0,u.jsx)(i,{...e,onOpenScreen:s})})}var l,u,d,f,p,m,h,g,_,v;function y(){return(y=e((()=>{l=t(),a(),u=s(),d={title:`Axis Experiences/Experience Atlas`,component:i,parameters:{layout:`fullscreen`,docs:{description:{component:`Exploratory, source-owned map of the canonical Nash Axis product areas and screen families. Coverage labels describe Storybook design maturity, not deployed product availability.`}}},render:e=>(0,u.jsx)(c,{...e})},f={args:{audience:`customer-admin`,initialFilter:`all`}},p={args:{audience:`customer-admin`,initialFilter:`reference`}},m={args:{audience:`customer-admin`,initialFilter:`designed`}},h={args:{audience:`customer-admin`,initialFilter:`restricted`}},g={args:{audience:`operator`,compact:!0,initialFilter:`all`}},_={args:{audience:`customer-admin`,initialQuery:`satellite teleportation`}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {
